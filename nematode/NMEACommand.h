...
class NMEACommandSerialConfiguration : public NMEACommand
{
 public:
  ...
  StopBits	1 			0,1		1. SiRF protocol is only valid for 8 data bits, 1stop
  bit, and no parity. Parity		0 			0=None, 1=Odd, 2=Even Checksum
  *0C <CR> <LF> End of message termination
  */
