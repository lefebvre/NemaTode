...
class GPSFix
{
 ...
 private:
  bool haslock;
  bool setlock(
      bool b);  // returns true if lock status **changed***, false otherwise.
 ...
 public:
  ...
  double horizontalDilution;  // Horizontal dilution of precision, initialized
                              // to 100, best =1, worst = >20
  ...
  static std::string travelAngleToCompassDirection(double deg,
                                                   bool abbrev = false);
};
